...
public class Day03_Dropdown {
    ...
    public void dropwdown1(){
        ...
        //dropdown iceriusindeki tum secenekleri almak istersek:
        List<WebElement> tumSecenekler=select.getOptions();
        for(WebElement w: tumSecenekler){
            System.out.println(w.getText());

        }
        System.out.println("Toplam ketegori sayisi : "+ tumSecenekler.size());
        //sadece secili secenegi prin almak icin
